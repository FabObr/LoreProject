...
public class Mop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = findViewById(R.id.textViewMop);
        ...
        myRef = database.getReference("MOP");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                TextView textView = (TextView) findViewById(R.id.textViewMop);
    ...
    public class FirstFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            view = inflater.inflate(R.layout.fragment_lore4, container, false);
            return view;
        }
    }
    ...
    public class SecondFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            view = inflater.inflate(R.layout.fragment_perso4, container, false);
            return view;
        }
    }
    ...
    private class ThirdFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            view = inflater.inflate(R.layout.fragment_lieux4, container, false);
            return view;
        }
    }
}
