...
public class Cata extends AppCompatActivity {
    ...
    public class FirstFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            view = inflater.inflate(R.layout.fragment_lore2, container, false);
            return view;
        }
    }
    ...
    public class SecondFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            view = inflater.inflate(R.layout.fragment_perso2, container, false);
            return view;
        }
    }
    ...
    private class ThirdFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            view = inflater.inflate(R.layout.fragment_lieux2, container, false);
            return view;
        }
    }
}
